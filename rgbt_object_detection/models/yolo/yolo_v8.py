...
class YOLOv8(YOLO):
    """
    This model uses the YOLOv8 architecture from ultralytics
    """
    ...
    def __init__(
        ...
        """
        Initializes the YOLOv8 model, according to selected modality and model size
        ...
        Args:
            ...
            model_size (str): The size of the YOLOv8 model. It can be 'N, 'S', 'M', 'L', or 'X'.
        ...
        if pre_trained_weights:
            ...
            if model_size == "N":
                selected_model_checkpoint = "yolov8n.pt"
            elif model_size == "S":
                selected_model_checkpoint = "yolov8s.pt"
            elif model_size == "M":
                selected_model_checkpoint = "yolov8m.pt"
            elif model_size == "L":
                selected_model_checkpoint = "yolov8l.pt"
            elif model_size == "X":
                selected_model_checkpoint = "yolov8x.pt"
            else:
