...
class YOLOv9(YOLO):
    """
    This model uses the YOLOv9 architecture from ultralytics
    """
    ...
    def __init__(
        ...
        """
        Initializes the YOLOv9 model, according to selected modality and model size
        ...
        Args:
            ...
            model_size (str): The size of the YOLOv9 model. It can be 'C', or 'E'.
        ...
        if pre_trained_weights:
            ...
            if model_size == "C":
                selected_model_checkpoint = "yolov9c.pt"
            elif model_size == "E":
                selected_model_checkpoint = "yolov9e.pt"
            else:
                raise ValueError("Invalid model size. Choose 'C', or 'E'")
