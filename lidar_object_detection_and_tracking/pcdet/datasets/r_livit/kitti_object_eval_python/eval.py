...
def clean_data(gt_anno, dt_anno, current_class, difficulty):
    CLASS_NAMES = ['car', 'pedestrian', 'cyclist', 'van', 'person_sitting', 'truck', 'bus', 'motorcycle', 'tramway']
    MIN_HEIGHT = [40, 25, 25]
    MAX_OCCLUSION = [0, 1, 2]
    ...
    # print("ignored_gt: ", ignored_gt)
    # print("ignored_dt: ", ignored_dt)
    # print("dc_bboxes: ", dc_bboxes)
    # print("--------------------------------")
...
def calculate_iou_partly(gt_annos, dt_annos, metric, num_parts=50):
    ...
    for num_part in split_parts:
        ...
        if metric == 0:
            ...
            # print("gt_boxes")
            # print("dimensions range: ")
            # print("l dimension: ", gt_boxes[:, 3:4].min(), gt_boxes[:, 3:4].max())
            # print("w dimension: ", gt_boxes[:, 4:5].min(), gt_boxes[:, 4:5].max())
            # print("h dimension: ", gt_boxes[:, 5:6].min(), gt_boxes[:, 5:6].max())
            # print("location range: ")
            # print("x dimension: ", gt_boxes[:, 0:1].min(), gt_boxes[:, 0:1].max())
            # print("y dimension: ", gt_boxes[:, 1:2].min(), gt_boxes[:, 1:2].max())
            # print("z dimension: ", gt_boxes[:, 2:3].min(), gt_boxes[:, 2:3].max())
            # print("--------------------------------")
            # print("dt_boxes")
            # print("dimensions range: ")
            # print("l dimension: ", dt_boxes[:, 3:4].min(), dt_boxes[:, 3:4].max())
            # print("w dimension: ", dt_boxes[:, 4:5].min(), dt_boxes[:, 4:5].max())
            # print("h dimension: ", dt_boxes[:, 5:6].min(), dt_boxes[:, 5:6].max())
            # print("location range: ")
            # print("x dimension: ", dt_boxes[:, 0:1].min(), dt_boxes[:, 0:1].max())
            # print("y dimension: ", dt_boxes[:, 1:2].min(), dt_boxes[:, 1:2].max())
            # print("z dimension: ", dt_boxes[:, 2:3].min(), dt_boxes[:, 2:3].max())
            # print("--------------------------------")
            # np.savetxt("/home/user/workspace/gt_boxes.txt", gt_boxes, fmt="%.2f", delimiter=" ")
            # np.savetxt("/home/user/workspace/dt_boxes.txt", dt_boxes, fmt="%.2f", delimiter=" ")
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    overlap_0_7 = np.array([[0.7, 0.5, 0.5, 0.7,0.5, 0.7], 
                            ...
                            [0.7, 0.5, 0.5, 0.7, 0.5, 0.7]])
    overlap_0_5 = np.array([[0.5, 0.25, 0.25, 0.5, 0.25, 0.5], 
                            [0.5, 0.25, 0.25, 0.5, 0.25, 0.5],
                            [0.5, 0.25, 0.25, 0.5, 0.25, 0.5]])
    
    # overlap_0_7 = np.array([[0.5, 0.3, 0.3, 0.5, 0.3, 0.5], 
    #                         [0.5, 0.3, 0.3, 0.5, 0.3, 0.5],
    #                         [0.5, 0.3, 0.3, 0.5, 0.3, 0.5]])
    # overlap_0_5 = np.array([[0.5, 0.3, 0.3, 0.5, 0.3, 0.5], 
